...
const BOOT_LINES = [
  ...
  { text: "  react ................... OK", style: "success" },
  { text: "  htmx .................... OK", style: "success" },
  { text: "  tailwind ................ OK", style: "success" },
  { text: "  django .................. OK", style: "success" },
  { text: "  postgres ................ OK", style: "success" },
  { text: "  cf-workers .............. OK", style: "success" },
  { text: "", style: "normal" },
  { text: "Mounting workspaces:", style: "normal" },
  { text: "  /dev/b1-marketing ....... ACTIVE", style: "cyan" },
  { text: "  /dev/balance ............ MOUNTED", style: "cyan" },
  { text: "  /dev/devize ............. ARCHIVED", style: "cyan" },
  { text: "", style: "normal" },
